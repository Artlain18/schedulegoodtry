...
public class PaymentScheduleBrowse extends Screen {
    ...
    public void setPayment(List<Payment> payments) {
        ...
        GroupTable<Payment> paymentsTable = (GroupTable<Payment>) getWindow().getComponentNN("paymentsTable");
        CollectionContainer<Payment> collection = new CollectionContainerImpl<>(
                metadata.getClassNN(Payment.class)
        );
        GroupTableItems<Payment> tableItems = new ContainerGroupTableItems<>(collection);
